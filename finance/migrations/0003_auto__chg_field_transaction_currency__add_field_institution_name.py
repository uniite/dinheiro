...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'finance_transaction', 'currency', self.gf('django.db.models.fields.CharField')(max_length=3))
        # Adding field 'Institution.name'
        db.add_column(u'finance_institution', 'name',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Transaction.currency'
        db.alter_column(u'finance_transaction', 'currency', self.gf('django.db.models.fields.CharField')(max_length=50))
        # Deleting field 'Institution.name'
        db.delete_column(u'finance_institution', 'name')
